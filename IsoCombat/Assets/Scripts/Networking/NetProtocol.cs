...
public enum NetOperation { NULL, HELLO, CHAT, STATE, SYSTEM, MG_READY, SHOW_RANK, BACK_TO_LOBBY, PLAY, FINISH_MATCH, UPGRADE_PICKED, STATS_SYNC, PLAYER_COLOR, ALL_COLORS, BULLET_HIT }
